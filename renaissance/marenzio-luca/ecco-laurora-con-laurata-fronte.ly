...
cantoLyrics = \lyricmode {
  ...
  Ec -- co che spon -- ta so -- pra l'or -- i -- zon -- te
  ...
  % line 4
  te
  Ec -- co la not - - - - - - - - -- te nell' ad -- ver -- so mon -- te
  che và fug -- gen -- do
  Che và fug -- gen -- d'al suo~an -- ti -- co sog -- gior --

  % line 5
  no
  Et io pur pian -- g'all' ap -- pa -- ri de l'al -- ba
...
altoLyrics = \lyricmode {
  ...
  % line 4
  mon - - - - - -- te
  Ec -- co la not -- te nel -- l'ad -- ver -- so mon -- te
  Che và fug -- gen -- d'al suo~an -- ti -- co sog -- gior - - - -- no

  % line 5
  al suo~an -- ti -- co sog -- gior -- no
  Et io pur pian -- g'al -- l'ap -- pa -- ri de l'al -- ba
...
tenoreNotes = {
  \transpose c' c' {
    ...
    \relative c' {
      ...
      d4 a4 e'2 a,2
      r4 a'4 g4 f4 e1 g2
      r1 r2 e1 a,1 c2 b1 b2 cs2 d4 d2 g4 g1 g1 % ! last note was g\breve
...
tenoreLyrics = \lyricmode {
  ...
  % line 3
  dor - -- no - - -
  Ec -- co la not -- te ne l'a -- ver -- so mon -- te ne l'ad -- ver -- so
      mon - - -- te
...
quintoLyrics = \lyricmode {
  % line 1
  Ec -- co l'aur -- ro -- ra con l'au -- ra -- ta fron -- te - -
  Ch'a pas -- so~a pas -- so
  ci ri -- me -- na~il gior -- no
  Ch'a
  ...
  Ec -- co che spon -- ta so -- pra l'Or -- ri -- zon -- te
  Col vol -- to suo di bian -- ca ne -- ve~a -- dor -- no
  Col
  ...
  al suo~an -- ti -- co sog -- gior -- no
  Che và fug -- gen -- d'al suo~an -- ti -- co sog -- gior -- no
  Et io pur pian -- g'all' ap -- pa -- rir de l'al- ba
  C'hio -- mai d'in --
